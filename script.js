...
var questionDatabase = [
  // Array con tutte le domande, le risposte, il numero di quella giusta
  {
...
function updateContainer(answerNumber) {
  // Funzione per settare il numero corretto di caselle disponibili per le risposte
  ...
  for (i = 0; i < answerNumber; i++) {
    // While per aggiungere dinamicamente il numero di div necessari per ogni domanda
...
function checkFunction(event) {
  ...
  if (currentQuestionNumber < QUESTION_NUMBER) {
...
function quiz() {
  ...
  document
    .getElementsByClassName('answer-table')[0]
    .addEventListener('on-answer-click', checkFunction, true);
